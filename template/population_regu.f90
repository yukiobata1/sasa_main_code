...
!�`�V�}�U�T�ȊO�̃T�T�͏��OFF �`�V�}�U�T�����ɂ���Ƃ��͂��̕������g������
!      pft_exist(C3g_no) = .false.
!      pft_exist(C4g_no) = .false.
!      pft_exist(23)     = .true.
!		 pft_exist(24)     = .false. 
...
!�~���R�U�T�ȊO�̃T�T�͏��OFF �~���R�U�T�����ɂ���Ƃ��͂��̕������g������
!      pft_exist(C3g_no) = .false.
!      pft_exist(C4g_no) = .false.
!      pft_exist(23)     = .false.
! 		pft_exist(24)     = .false.
